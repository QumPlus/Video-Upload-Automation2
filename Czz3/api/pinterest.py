    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("Pinterest API: Invalid access token")
                return False
            elif response.status_code == 403:
                print("Pinterest API: Access forbidden")
                return False
            else:
            ...
            print(f"Pinterest API connection error: {e}")
            return False
        except Exception as e:
            print(f"Pinterest API test error: {e}")
            return False
